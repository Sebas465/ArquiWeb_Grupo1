...
TRUNCATE TABLE progreso_salud  RESTART IDENTITY CASCADE;
...
INSERT INTO usuario (username, email, contrasena_hash, nombre, apellido, id_rol) VALUES
  ('jose_admin',  'jose@kh.pe',   '$2a$10$7EqJtq98hPqEX7fNZaFWoOa3uT1MkZHkZqFmFqFmFqFmFqFmFqFmF', 'Jose',    'Milla',   4),
  ('ana_nutri',   'ana@kh.pe',    '$2a$10$7EqJtq98hPqEX7fNZaFWoOa3uT1MkZHkZqFmFqFmFqFmFqFmFqFmF', 'Ana',     'Garcia',  2),
  ('carlos_fit',  'carlos@kh.pe', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Carlos',  'Ruiz',    3),
  ('maria_user',  'maria@kh.pe',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Maria',   'Lopez',   1);
...
-- ================================================================
-- 10. PROGRESO DE SALUD
-- ================================================================
INSERT INTO progreso_salud (id_usuario, fecha, peso_kg, talla_cm, imc, alergias) VALUES
  (4, '2026-06-01', 70.0, 170, 24.2, 'Lactosa'),
  (4, '2026-06-08', 69.5, 170, 24.0, 'Lactosa'),
  (4, '2026-06-15', 68.8, 170, 23.8, 'Lactosa'),
  (3, '2026-06-01', 80.0, 180, 24.7, 'Ninguna'),
  (3, '2026-06-15', 79.0, 180, 24.4, 'Ninguna'),
  (1, '2026-06-20', 75.0, 175, 24.5, 'Gluten');
...
UNION ALL
SELECT 'progreso_salud', COUNT(*) FROM progreso_salud;
